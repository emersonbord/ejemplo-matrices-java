public class EjemploMatrices {
    ...
    public static void main(String[] args) {
        int[][] numeros = new int[2][4];//MATRIZ DE 2X4

        System.out.println("Número de filas: " + numeros.length); //Saber cantidad de filas
        System.out.println("Número de columnas: " + numeros[0].length); //Saber cantidad de elementos
